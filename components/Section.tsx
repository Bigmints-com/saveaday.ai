...
export default function Section({
  ...
  return (
    ...
    >
      ...
      >
        {eyebrow ? (
          <span className="inline-flex items-center gap-2 rounded-full border border-brand-blue/30 bg-brand-blue/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.35em] text-brand-blue/80">
            {eyebrow}
          </span>
        ) : null}
